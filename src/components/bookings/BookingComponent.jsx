                                        ...
                                        {currentRecords.map(record => {
                                            return (
                                                <tr>
                                                    ...
                                                    <td style={{ fontSize: '0.7rem', textDecoration: 'none', cursor: 'none', color: 'white', height: '30px', marginTop: '30p' }} data-label="Status"><label style={{ backgroundColor: '#1ABC9C', height: '40px', width: '50%', paddingTop: '9px' ,textAlign:'center' }}>Active</label></td>
                                                </tr>
                                            )
                                        })}
